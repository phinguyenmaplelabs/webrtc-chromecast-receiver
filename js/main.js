...
function connect(port) {
    socket = new WebSocket("http://192.168.68.52".replace('http://', 'ws://').concat(':').concat(port)), socket.binaryType = 'blob', socket.onopen = function (event) {}, socket.onmessage = function (event) {
